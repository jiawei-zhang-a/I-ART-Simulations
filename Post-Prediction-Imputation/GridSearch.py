...
if __name__ == '__main__':
    ...
    for i in [0,1,2,5,10,20,50,100]:
        ...
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=missForest, G2=missForest)
        ...
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=BayesianRidge, G2=BayesianRidge)
        ...
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=NystroemKernel, G2=NystroemKernel)
        ...
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=XGBoost, G2=XGBoost)
        ...
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=NN_imputer, G2=NN_imputer)
        print("p-values for part 1:", p1)
        print("p-values for part 2:", p2)

        #test Median imputer
        median_imputer = SimpleImputer(missing_values=np.nan, strategy='median')
        p1, p2 = Framework.one_shot_test_parallel(Z, X, M, Y, S, G1=median_imputer, G2=median_imputer)
