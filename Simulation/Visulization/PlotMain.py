...
def main_pic_generator():
    ...
    plot(np.arange(0.0, 0.18, 0.03), np.arange(0.0, 1.2, 0.2), "../Data/ResultMultiple/HPC_power_1000_Model5", "../Data/ResultMultiple/HPC_power_50_Model5", "Size1000_Model5", "Size50_Model5", multiple=True)
