...
def plot_results(data, title, xsticks, lr, gbm):
    ...
    plt.scatter(0, lr, color='red', marker='x', s=50, label="Custom Triangle")
    plt.scatter(0, gbm, color='green', marker='x', s=50,  label="Custom Square")
...
def load_and_plot(main_filename, small_filename, title_main, title_small, xsticks_main, xsticks_small, lr50, gbm50, lr1000, gbm1000):
    ...
    plot_results(main_data, title_main, xsticks_main, lr1000, gbm1000)
    plot_results(small_data, title_small, xsticks_small, lr50, gbm50)

def main_pic_plotter():
    load_and_plot("Size1000_Model1.pkl", "Size50_Model1.pkl", "Size1000_Model1", "Size50_Model1", 
                  np.arange(0.0, 0.42, 0.07), np.arange(0, 1.5, 0.25), 0.1115,0.0985, 0.181,0.189)
    load_and_plot("Size1000_Model2.pkl", "Size50_Model2.pkl", "Size1000_Model2", "Size50_Model2", 
                  np.arange(0.0, 0.96, 0.16), np.arange(0.0, 4.8, 0.8), 0.084, 0.0905, 0.0755, 0.14)
    load_and_plot("Size1000_Model3.pkl", "Size50_Model3.pkl", "Size1000_Model3", "Size50_Model3", 
                  np.arange(0.0, 0.36, 0.06), np.arange(0.0, 1.5, 0.25), 0.0865, 0.09, 0.0895, 0.14)
    load_and_plot("Size1000_Model4.pkl", "Size50_Model4.pkl", "Size1000_Model4", "Size50_Model4", 
                  np.arange(0.0, 0.36, 0.06), np.arange(0.0, 1.5, 0.25), 0.0765, 0.0905, 0.0845, 0.127)
