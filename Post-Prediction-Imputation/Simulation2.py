...
class DataGenerator:
  def __init__(self,*, N = 1000, strata_size = 10, beta_11 = 1, beta_12 = 1, beta_21 = 1, beta_22 = 1, beta_23 = 1, beta_31 = 1,beta_32 = 1, MaskRate = 0.3, Single = True,  verbose = False, bias = False, Missing_lambda= None):
    self.N = N
