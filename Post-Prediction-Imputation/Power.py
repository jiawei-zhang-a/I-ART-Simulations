...
if __name__ == '__main__':
    ...
    for coef in np.arange(0.0,0.3 ,0.05):
        ...
        if beta_coef_rounded in beta_to_lambda:
            ...
            run(1000, Single = 1, filepath = "Result/HPC_power_1000_unobserved_interference_adjusted" + "_single", adjust = 1, strata_size = S_size, Missing_lambda = lambda_value, small_size=False)
        else:
